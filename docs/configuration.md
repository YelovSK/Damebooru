...
| `Damebooru:Storage:DataProtectionKeysPath` | `Damebooru__Storage__DataProtectionKeysPath` | `data/keys` | Login cookie encryption keys; must persist across restarts |
