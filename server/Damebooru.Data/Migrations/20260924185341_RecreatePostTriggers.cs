...
{
    /// <inheritdoc />
    public partial class RecreatePostTriggers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Posts.FileModifiedDate is the earliest modified date of the post's files; it drives sorting.
            migrationBuilder.Sql(
                """
                CREATE TRIGGER trg_postfiles_ai_post_file_modified_date
                AFTER INSERT ON PostFiles
                BEGIN
                    UPDATE Posts
                    SET FileModifiedDate = (SELECT MIN(FileModifiedDate) FROM PostFiles WHERE PostId = NEW.PostId)
                    WHERE Id = NEW.PostId;
                END;
                """);
            ...
            migrationBuilder.Sql(
                """
                CREATE TRIGGER trg_postfiles_au_post_file_modified_date
                ...
                BEGIN
                    ...
                    UPDATE Posts
                    SET FileModifiedDate = COALESCE((SELECT MIN(FileModifiedDate) FROM PostFiles WHERE PostId = OLD.PostId), FileModifiedDate)
                    WHERE Id = OLD.PostId AND OLD.PostId <> NEW.PostId;
                END;
                """);

            migrationBuilder.Sql(
                """
                CREATE TRIGGER trg_postfiles_ad_post_file_modified_date
            ...
            migrationBuilder.Sql(
                """
                CREATE TRIGGER trg_posts_au_audit_is_favorite
            ...
            migrationBuilder.Sql(
                """
                CREATE TRIGGER trg_postsources_ai_audit
            ...
            migrationBuilder.Sql(
                """
                CREATE TRIGGER trg_postsources_ad_audit
            ...
            migrationBuilder.Sql(
                """
                CREATE TRIGGER trg_postsources_au_audit_url
