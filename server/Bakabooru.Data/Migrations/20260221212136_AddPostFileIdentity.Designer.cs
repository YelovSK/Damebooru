...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bakabooru.Core.Entities.TagCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bakabooru.Core.Entities.PostTag", b =>
                {
                    ...
                    b.HasOne("Bakabooru.Core.Entities.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Bakabooru.Core.Entities.Tag", b =>
                {
                    b.HasOne("Bakabooru.Core.Entities.TagCategory", "TagCategory")
                        .WithMany("Tags")
