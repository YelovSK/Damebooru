...
public sealed class AutoTagPostsJob : IJob
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (mode == JobMode.All)
        {
            ...
            return await AutoTagCandidateFilter.ExcludeAutoTagIgnoredPathsAsync(db, allPostIds, cancellationToken);
        }
        ...
        return await AutoTagCandidateFilter.ExcludeAutoTagIgnoredPathsAsync(db, missingPostIds, cancellationToken);
    }
}
